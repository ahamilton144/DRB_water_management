...
def run_model(inflow_type, predict_temperature, timer):
    ...
    model_filename = rf"{pn.pywrdrb.model_data.dir()}/drb_model_full_{inflow_type}_{tname}.json"
...
#%%
def plot_temp(df, dates=["1983-10-01", "2016-12-31"], add_band=False, inflow_type="", ylim=(20, 30), threshold=23.89, df_obv=None):
